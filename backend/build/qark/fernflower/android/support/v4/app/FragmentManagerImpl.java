...
final class FragmentManagerImpl extends FragmentManager {
   ...
   public void attachActivity(FragmentActivity var1) {
   ...
   public boolean dispatchContextItemSelected(MenuItem var1) {
      if (this.mAdded != null) {
         for(int var2 = 0; var2 < this.mAdded.size(); ++var2) {
            Fragment var3 = (Fragment)this.mAdded.get(var2);
            if (var3 != null && !var3.mHidden && var3.mUserVisibleHint && var3.onContextItemSelected(var1)) {
               return true;
            }
         }
      }
            ...
            if (var8 != null) {
               ...
               if (!var8.mHidden) {
                  ...
                  if (var8.mHasMenu) {
                     var7 = var6;
                     var5 = var4;
                     if (var8.mMenuVisible) {
                        var5 = true;
                        var8.onCreateOptionsMenu(var1, var2);
                        var7 = var6;
                        if (var6 == null) {
                           var7 = new ArrayList();
                        }
   ...
   public boolean dispatchOptionsItemSelected(MenuItem var1) {
      if (this.mAdded != null) {
         for(int var2 = 0; var2 < this.mAdded.size(); ++var2) {
            Fragment var3 = (Fragment)this.mAdded.get(var2);
            if (var3 != null && !var3.mHidden && var3.mHasMenu && var3.mMenuVisible && var3.onOptionsItemSelected(var1)) {
               return true;
            }
         }
      }
   ...
   public void dispatchOptionsMenuClosed(Menu var1) {
      if (this.mAdded != null) {
         for(int var2 = 0; var2 < this.mAdded.size(); ++var2) {
            Fragment var3 = (Fragment)this.mAdded.get(var2);
            if (var3 != null && !var3.mHidden && var3.mHasMenu && var3.mMenuVisible) {
               var3.onOptionsMenuClosed(var1);
            }
         }
      }
         ...
         while(true) {
            ...
            if (var5 != null) {
               ...
               if (!var5.mHidden) {
                  ...
                  if (var5.mHasMenu) {
                     var4 = var3;
                     if (var5.mMenuVisible) {
                        var4 = true;
                        var5.onPrepareOptionsMenu(var1);
                     }
                  }
               }
            }
   ...
   public Fragment findFragmentByWho(String var1) {
      if (this.mActive != null && var1 != null) {
         for(int var2 = this.mActive.size() - 1; var2 >= 0; --var2) {
            ...
            if (var3 != null && var1.equals(var3.mWho)) {
               return var3;
            }
         }
      }
   ...
   void makeActive(Fragment var1) {
      if (var1.mIndex < 0) {
         if (this.mAvailIndices != null && this.mAvailIndices.size() > 0) {
            var1.setIndex((Integer)this.mAvailIndices.remove(this.mAvailIndices.size() - 1));
            ...
            var1.setIndex(this.mActive.size());
   ...
   void makeInactive(Fragment var1) {
      if (var1.mIndex >= 0) {
         ...
         this.mActivity.invalidateSupportFragmentIndex(var1.mIndex);
         var1.initState();
      }
   }
   ...
   void moveToState(final Fragment var1, int var2, int var3, int var4, boolean var5) {
      ...
      if (var1.mState < var2) {
         ...
         case 0:
            ...
            var1.mFragmentManager = this.mActivity.mFragments;
            var1.mCalled = false;
            ...
            if (!var1.mRetaining) {
               var1.mCalled = false;
               var1.onCreate(var1.mSavedFragmentState);
               if (!var1.mCalled) {
                  throw new SuperNotCalledException("Fragment " + var1 + " did not call through to super.onCreate()");
               }
            }
            ...
            var6 = var7;
            if (var1.mFromLayout) {
               var1.mView = var1.onCreateView(var1.getLayoutInflater(var1.mSavedFragmentState), (ViewGroup)null, var1.mSavedFragmentState);
               if (var1.mView != null) {
            ...
            if (var6 > 1) {
               ...
               if (!var1.mFromLayout) {
                  ...
                  if (var1.mContainerId != 0) {
                     var10 = (ViewGroup)this.mActivity.findViewById(var1.mContainerId);
                     var9 = var10;
                     if (var10 == null) {
                        var9 = var10;
                        if (!var1.mRestored) {
                           throw new IllegalArgumentException("No view found for id 0x" + Integer.toHexString(var1.mContainerId) + " for fragment " + var1);
                        }
                     }
                  }

                  var1.mContainer = var9;
                  var1.mView = var1.onCreateView(var1.getLayoutInflater(var1.mSavedFragmentState), var9, var1.mSavedFragmentState);
                  if (var1.mView != null) {
                     var1.mInnerView = var1.mView;
                     var1.mView = NoSaveStateFrameLayout.wrap(var1.mView);
                     if (var9 != null) {
               ...
               var1.mCalled = false;
               var1.onActivityCreated(var1.mSavedFragmentState);
               if (!var1.mCalled) {
                  throw new SuperNotCalledException("Fragment " + var1 + " did not call through to super.onActivityCreated()");
               }

               if (var1.mView != null) {
                  var1.restoreViewState();
               }
         ...
         case 3:
            ...
            if (var8 > 3) {
               ...
               var7 = var8;
               if (!var1.mCalled) {
                  throw new SuperNotCalledException("Fragment " + var1 + " did not call through to super.onStart()");
               }
            }
         case 4:
            var6 = var7;
            if (var7 > 4) {
               ...
               var1.onResume();
               if (!var1.mCalled) {
                  throw new SuperNotCalledException("Fragment " + var1 + " did not call through to super.onResume()");
               }
         ...
         if (var1.mState > var2) {
            ...
            case 5:
               if (var2 < 5) {
                  ...
                  var1.onPause();
                  if (!var1.mCalled) {
                     throw new SuperNotCalledException("Fragment " + var1 + " did not call through to super.onPause()");
                  }
            ...
            case 4:
               if (var2 < 4) {
                  ...
                  var1.performStop();
                  if (!var1.mCalled) {
                     throw new SuperNotCalledException("Fragment " + var1 + " did not call through to super.onStop()");
                  }
               }
            case 3:
               if (var2 < 3) {
            ...
            case 2:
               if (var2 < 2) {
                  ...
                  if (!var1.mCalled) {
                     throw new SuperNotCalledException("Fragment " + var1 + " did not call through to super.onDestroyView()");
                  }

                  if (var1.mView != null && var1.mContainer != null) {
                     var10 = null;
                     Animation var11 = var10;
                     if (this.mCurState > 0) {
                        var11 = var10;
                        if (!this.mDestroyed) {
                           var11 = this.loadAnimation(var1, var3, false, var4);
                        }
                     }
                     ...
                     if (var11 != null) {
                        ...
                        var11.setAnimationListener(new AnimationListener() {
                        ...
                        var1.mView.startAnimation(var11);
                     }
            ...
            case 1:
               ...
               if (var2 < 1) {
                  if (this.mDestroyed && var1.mAnimatingAway != null) {
                     View var13 = var1.mAnimatingAway;
                     var1.mAnimatingAway = null;
                  ...
                  if (var1.mAnimatingAway != null) {
                     ...
                     if (!var1.mRetaining) {
                        ...
                        var1.onDestroy();
                        if (!var1.mCalled) {
                           throw new SuperNotCalledException("Fragment " + var1 + " did not call through to super.onDestroy()");
                        }
                     }
      ...
      if (var1 != null) {
         ...
         if (var6.mActive != null) {
            ...
            for(var3 = 0; var3 < var6.mActive.length; ++var3) {
               ...
               if (var9 != null) {
                  Fragment var10 = var9.instantiate(this.mActivity);
                  if (DEBUG) {
                     Log.v("FragmentManager", "restoreAllState: adding #" + var3 + ": " + var10);
                  }
            ...
            if (var6.mAdded != null) {
               ...
               for(var3 = 0; var3 < var6.mAdded.length; ++var3) {
                  ...
                  if (var7 == null) {
                     throw new IllegalStateException("No instantiated fragment for index #" + var6.mAdded[var3]);
                  }

                  var7.mAdded = true;
                  if (DEBUG) {
                     Log.v("FragmentManager", "restoreAllState: making added #" + var3 + ": " + var7);
                  }
            ...
            for(var3 = 0; var3 < var6.mBackStack.length; ++var3) {
               ...
               if (DEBUG) {
                  Log.v("FragmentManager", "restoreAllState: adding bse #" + var3 + " (index " + var8.mIndex + "): " + var8);
               }
   ...
   Parcelable saveAllState() {
      ...
      if (this.mActive != null && this.mActive.size() > 0) {
         ...
         for(var1 = 0; var1 < var4; ++var1) {
            ...
            if (var5 != null) {
               if (var5.mIndex < 0) {
                  var10 = "Failure saving state: active " + var5 + " has cleared index: " + var5.mIndex;
                  Log.e("FragmentManager", var10);
                  this.dump("  ", (FileDescriptor)null, new PrintWriter(new LogWriter("FragmentManager")), new String[0]);
               ...
               if (var5.mState > 0 && var6.mSavedFragmentState == null) {
                  ...
                  if (var5.mTarget != null) {
                     if (var5.mTarget.mIndex < 0) {
                        var10 = "Failure saving state: " + var5 + " has target not in fragment manager: " + var5.mTarget;
                        Log.e("FragmentManager", var10);
                        this.dump("  ", (FileDescriptor)null, new PrintWriter(new LogWriter("FragmentManager")), new String[0]);
                        throw new IllegalStateException(var10);
                     }
            ...
            if (this.mAdded != null) {
               ...
               if (var9 > 0) {
                  ...
                  while(true) {
                     ...
                     if (var12[var1] < 0) {
                        var10 = "Failure saving state: active " + this.mAdded.get(var1) + " has cleared index: " + var12[var1];
                        Log.e("FragmentManager", var10);
                        this.dump("  ", (FileDescriptor)null, new PrintWriter(new LogWriter("FragmentManager")), new String[0]);
                        throw new IllegalStateException(var10);
                     }
   ...
   Bundle saveFragmentBasicState(Fragment var1) {
      ...
      var1.onSaveInstanceState(this.mStateBundle);
   ...
   public Fragment.SavedState saveFragmentInstanceState(Fragment var1) {
      Object var3 = null;
      if (var1.mIndex < 0) {
         throw new IllegalStateException("Fragment " + var1 + " is not currently in the FragmentManager");
      } else {
