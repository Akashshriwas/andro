...
import com.google.android.gms.class_387;
...
public final class class_188 {
   ...
   public static int method_793(Context var0) {
      ...
      if (System.currentTimeMillis() < 1227312000288L) {
         ...
         byte[] var8 = method_797(var7, field_630);
         if (var8 == null) {
            ...
            if (method_797(var2, var8) == null) {
               Log.w("GooglePlayServicesUtil", "Google Play services signature invalid.");
               return 9;
            } else if (var2.versionCode < 4132500) {
               Log.w("GooglePlayServicesUtil", "Google Play services out of date.  Requires 4132500 but found " + var2.versionCode);
               return 2;
            } else {
               ApplicationInfo var9;
               try {
                  var9 = var1.getApplicationInfo("com.google.android.gms", 0);
   ...
   public static Intent method_794(Context var0, int var1, int var2) {
      switch(var1) {
      case 1:
      case 2:
         if (method_796(var2)) {
            if (method_804(var0)) {
               return class_323.method_1070("com.google.android.gms");
            }

            return class_323.method_1069("com.google.android.apps.bazaar");
         }

         return class_323.method_1069("com.google.android.gms");
      case 3:
         return class_323.method_1068("com.google.android.gms");
      case 12:
         return class_323.method_1067();
      default:
         return null;
      }
   }
   ...
   public static boolean method_795() {
      return field_635 ? field_636 : "user".equals(Build.TYPE);
   }

   // $FF: renamed from: a (int) boolean
   static boolean method_796(int var0) {
      boolean var2 = true;
      boolean var1 = var2;
      switch(method_800(var0)) {
      case 0:
         var1 = var2;
         if (method_795()) {
            return false;
   ...
   private static byte[] method_797(PackageInfo var0, byte[]... var1) {
   ...
   private static byte[] method_798(String var0) {
      try {
   ...
   private static byte[][] method_799(byte[][]... var0) {
      ...
      for(var1 = 0; var2 < var4; ++var2) {
         ...
         for(var3 = 0; var3 < var6.length; ++var1) {
            var5[var1] = var6[var3];
            ++var3;
         }
      }
   ...
   private static int method_800(int var0) {
      int var1 = var0;
      if (var0 == -1) {
         var1 = 2;
      }
   ...
   public static void method_801(Context var0) {
      int var1 = method_793(var0);
      if (var1 != 0) {
         Intent var2 = method_794(var0, var1, -1);
         Log.e("GooglePlayServicesUtil", "GooglePlayServices not available due to error " + var1);
         if (var2 == null) {
            throw new class_175(var1);
         } else {
            throw new class_180(var1, "Google Play Services not available", var2);
         }
      }
   }

   // $FF: renamed from: c (android.content.Context) android.content.Context
   public static Context method_802(Context var0) {
      try {
   ...
   private static void method_803(Context var0) {
      Object var2 = null;
      ...
      if (var5 != null) {
         ...
         if (var1 != 4132500) {
            throw new IllegalStateException("The meta-data tag in your app's AndroidManifest.xml does not have the right value.  Expected 4132500 but found " + var1 + ".  You must have the" + " following declaration within the <application> element: " + "    <meta-data android:name=\"" + "com.google.android.gms.version" + "\" android:value=\"@integer/google_play_services_version\" />");
         }
      } else {
   ...
   // $FF: renamed from: e (android.content.Context) boolean
   private static boolean method_804(Context var0) {
      boolean var1 = false;
      if (field_635) {
         var1 = field_637;
      } else {
         byte[] var3;
         try {
            var3 = method_797(var0.getPackageManager().getPackageInfo("com.google.android.apps.bazaar", 64), field_634);
