...
public final class g {
    ...
    public static int a(Context applicationInfo) {
        PackageInfo packageInfo;
        PackageManager packageManager = applicationInfo.getPackageManager();
        try {
            applicationInfo.getResources().getString(b.common_google_play_services_unknown_issue);
        }
        ...
        while (System.currentTimeMillis() < 1227312000288L) {
            return 12;
        }
        g.d((Context)applicationInfo);
        try {
            applicationInfo = packageManager.getPackageInfo("com.android.vending", 64);
        }
        catch (PackageManager.NameNotFoundException nameNotFoundException) {
            Log.w((String)"GooglePlayServicesUtil", (String)"Google Play Store is missing.");
            return 9;
        }
        applicationInfo = g.a((PackageInfo)applicationInfo, a);
        ...
        if (g.a(packageInfo, (byte[][])new byte[][]{applicationInfo}) == null) {
            Log.w((String)"GooglePlayServicesUtil", (String)"Google Play services signature invalid.");
            return 9;
        }
        if (packageInfo.versionCode < 4132500) {
            Log.w((String)"GooglePlayServicesUtil", (String)("Google Play services out of date.  Requires 4132500 but found " + packageInfo.versionCode));
            return 2;
        }
        try {
     ...
     */
    private static /* varargs */ byte[] a(PackageInfo arrby, byte[] ... arrby2) {
        byte[] arrby3;
        try {
            arrby3 = CertificateFactory.getInstance((String)"X509");
        }
        catch (CertificateException certificateException) {
            Log.w((String)"GooglePlayServicesUtil", (String)"Could not get certificate instance.");
            return null;
        }
        if (arrby.signatures.length != 1) {
            Log.w((String)"GooglePlayServicesUtil", (String)"Package has more than one signature.");
            return null;
        }
        ByteArrayInputStream byteArrayInputStream = new ByteArrayInputStream(arrby.signatures[0].toByteArray());
        try {
            arrby3 = (X509Certificate)arrby3.generateCertificate((InputStream)byteArrayInputStream);
        }
        catch (CertificateException certificateException) {
        ...
        arrby = arrby.signatures[0].toByteArray();
        for (int i2 = 0; i2 < arrby2.length; ++i2) {
            arrby3 = arrby2[i2];
            if (!Arrays.equals((byte[])arrby3, (byte[])arrby)) continue;
            return arrby3;
        }
    ...
    private static /* varargs */ byte[][] a(byte[][] ... arrby) {
        int n2;
        int n3 = arrby.length;
        int n4 = 0;
        for (n2 = 0; n2 < n3; ++n2) {
    ...
    private static void d(Context context) {
        ...
        if ((context = context.metaData) != null) {
            int n2 = context.getInt("com.google.android.gms.version");
            if (n2 == 4132500) {
                return;
            }
            throw new IllegalStateException("The meta-data tag in your app's AndroidManifest.xml does not have the right value.  Expected 4132500 but found " + n2 + ".  You must have the" + " following declaration within the <application> element: " + "    <meta-data android:name=\"" + "com.google.android.gms.version" + "\" android:value=\"@integer/google_play_services_version\" />");
        }
     ...
     * Lifted jumps to return sites
     */
    private static boolean e(Context arrby) {
        boolean bl2 = false;
        if (f) {
            return h;
        }
        try {
            if ((arrby = g.a(arrby.getPackageManager().getPackageInfo("com.google.android.apps.bazaar", 64), e)) == null) return bl2;
            return true;
        }
        catch (PackageManager.NameNotFoundException nameNotFoundException) {
            return false;
