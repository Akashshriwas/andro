...
public class AccessibilityNodeInfoCompat {
    ...
    private static final AccessibilityNodeInfoImpl IMPL = Build.VERSION.SDK_INT >= 16 ? new AccessibilityNodeInfoJellybeanImpl() : (Build.VERSION.SDK_INT >= 14 ? new AccessibilityNodeInfoIcsImpl() : new AccessibilityNodeInfoStubImpl());
    ...
    public List<AccessibilityNodeInfoCompat> findAccessibilityNodeInfosByText(String list) {
        ArrayList arrayList = new ArrayList();
        list = IMPL.findAccessibilityNodeInfosByText(this.mInfo, (String)list);
        int n = list.size();
        for (int i = 0; i < n; ++i) {
            arrayList.add((Object)new AccessibilityNodeInfoCompat(list.get(i)));
        }
        return arrayList;
    }
