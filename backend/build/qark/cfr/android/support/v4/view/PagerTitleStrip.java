...
implements ViewPager.Decor {
    ...
    protected void onMeasure(int n, int n2) {
        ...
        int n6 = View.MeasureSpec.makeMeasureSpec((int)((int)((float)n * 0.8f)), (int)Integer.MIN_VALUE);
        int n7 = View.MeasureSpec.makeMeasureSpec((int)(n2 - n5), (int)Integer.MIN_VALUE);
        ...
        this.setMeasuredDimension(n, Math.max((int)n3, (int)(this.mCurrText.getMeasuredHeight() + n5)));
    }
    ...
    void updateText(int n, PagerAdapter pagerAdapter) {
        ...
        if (n >= 1) {
            textView2 = textView;
            if (pagerAdapter != null) {
                textView2 = pagerAdapter.getPageTitle(n - 1);
            }
        }
        this.mPrevText.setText((CharSequence)textView2);
        textView = this.mCurrText;
        textView2 = pagerAdapter != null && n < n2 ? pagerAdapter.getPageTitle(n) : null;
        textView.setText((CharSequence)textView2);
        ...
        this.mNextText.setText((CharSequence)textView2);
        ...
        n3 = View.MeasureSpec.makeMeasureSpec((int)((int)((float)(n3 - n4 - n5) * 0.8f)), (int)Integer.MIN_VALUE);
        n2 = View.MeasureSpec.makeMeasureSpec((int)(n2 - n6 - n7), (int)Integer.MIN_VALUE);
    ...
    void updateTextPositions(int n, float f, boolean bl) {
        ...
        int n14 = Math.max((int)Math.max((int)n12, (int)n13), (int)n11);
        n12 = n14 - n12;
        n13 = n14 - n13;
        n11 = n14 - n11;
        ...
        n14 = Math.max((int)Math.max((int)(n12 + n14), (int)(n13 + n15)), (int)(n11 + n16));
        ...
        n7 = Math.min((int)n8, (int)(n5 - this.mScaledTextSpacing - n2));
        this.mPrevText.layout(n7, n10, n7 + n2, this.mPrevText.getMeasuredHeight() + n10);
        n7 = Math.max((int)(n6 - n9 - n4), (int)(this.mScaledTextSpacing + n3));
