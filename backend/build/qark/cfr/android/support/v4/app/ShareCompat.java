...
public class ShareCompat {
    ...
    public static class IntentBuilder {
        ...
        private void combineArrayExtra(String string2, ArrayList<String> arrayList) {
            ...
            Object[] arrobject = new String[arrayList.size() + n];
            arrayList.toArray(arrobject);
            if (arrstring != null) {
                System.arraycopy((Object)arrstring, (int)0, (Object)arrobject, (int)arrayList.size(), (int)n);
            }
        ...
        private void combineArrayExtra(String string2, String[] arrstring) {
            ...
            if (arrstring2 != null) {
                System.arraycopy((Object)arrstring2, (int)0, (Object)arrstring3, (int)0, (int)n);
            }
            System.arraycopy((Object)arrstring, (int)0, (Object)arrstring3, (int)n, (int)arrstring.length);
        ...
        public Intent getIntent() {
            ...
            boolean bl2 = this.mIntent.getAction().equals((Object)"android.intent.action.SEND_MULTIPLE");
            if (!bl && bl2) {
    ...
    public static class IntentReader {
        ...
        public CharSequence getCallingApplicationLabel() {
            ...
            PackageManager packageManager = this.mActivity.getPackageManager();
            try {
                packageManager = packageManager.getApplicationLabel(packageManager.getApplicationInfo(this.mCallingPackage, 0));
                return packageManager;
            }
            catch (PackageManager.NameNotFoundException nameNotFoundException) {
        ...
        public String getHtmlText() {
            ...
            if (this.mIntent != null) return string3;
        ...
        public Uri getStream(int n) {
            ...
            if (this.mStreams != null) {
                return (Uri)this.mStreams.get(n);
            }
            if (n == 0) {
                return (Uri)this.mIntent.getParcelableExtra("android.intent.extra.STREAM");
            }
        ...
        public boolean isMultipleShare() {
            return this.mIntent.getAction().equals((Object)"android.intent.action.SEND_MULTIPLE");
        }

        public boolean isShareIntent() {
            String string2 = this.mIntent.getAction();
            if (string2.equals((Object)"android.intent.action.SEND") || string2.equals((Object)"android.intent.action.SEND_MULTIPLE")) {
                return true;
            }
            return false;
        }
        ...
        public boolean isSingleShare() {
            return this.mIntent.getAction().equals((Object)"android.intent.action.SEND");
        }
    }
