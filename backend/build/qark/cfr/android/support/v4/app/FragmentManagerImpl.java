...
extends FragmentManager {
    ...
    public boolean dispatchContextItemSelected(MenuItem menuItem) {
        if (this.mAdded != null) {
            for (int i = 0; i < this.mAdded.size(); ++i) {
                Fragment fragment = (Fragment)this.mAdded.get(i);
                if (fragment == null || fragment.mHidden || !fragment.mUserVisibleHint || !fragment.onContextItemSelected(menuItem)) continue;
                return true;
            }
        }
        return false;
    ...
    public boolean dispatchOptionsItemSelected(MenuItem menuItem) {
        if (this.mAdded != null) {
            for (int i = 0; i < this.mAdded.size(); ++i) {
                Fragment fragment = (Fragment)this.mAdded.get(i);
                if (fragment == null || fragment.mHidden || !fragment.mHasMenu || !fragment.mMenuVisible || !fragment.onOptionsItemSelected(menuItem)) continue;
                return true;
            }
        }
        return false;
    ...
    public Fragment findFragmentByWho(String string2) {
        if (this.mActive != null && string2 != null) {
            for (int i = this.mActive.size() - 1; i >= 0; --i) {
                ...
                if (fragment == null || !string2.equals((Object)fragment.mWho)) continue;
                return fragment;
            }
        }
        return null;
        ...
        block7 : {
            block6 : {
                ...
                if (this.mAvailIndices == null || this.mAvailIndices.size() <= 0) {
                    ...
                    fragment.setIndex((Integer)this.mAvailIndices.remove(this.mAvailIndices.size() - 1));
    ...
    void restoreAllState(Parcelable parcelable, ArrayList<Fragment> object) {
        ...
        for (n = 0; n < parcelable.mActive.length; ++n) {
            ...
            if (object2 != null) {
                object3 = object2.instantiate(this.mActivity);
                if (DEBUG) {
                    Log.v((String)"FragmentManager", (String)("restoreAllState: adding #" + n + ": " + object3));
                }
            ...
            if (DEBUG) {
                Log.v((String)"FragmentManager", (String)("restoreAllState: adding #" + n + ": (null)"));
            }
            ...
            if (DEBUG) {
                Log.v((String)"FragmentManager", (String)("restoreAllState: adding avail #" + n));
            }
        ...
        if (parcelable.mAdded == null) {
            ...
            for (n = 0; n < parcelable.mAdded.length; ++n) {
                ...
                if (object == null) {
                    throw new IllegalStateException("No instantiated fragment for index #" + parcelable.mAdded[n]);
                }
                object.mAdded = true;
                if (DEBUG) {
                    Log.v((String)"FragmentManager", (String)("restoreAllState: making added #" + n + ": " + object));
                }
        ...
        while (n < parcelable.mBackStack.length) {
            ...
            if (DEBUG) {
                Log.v((String)"FragmentManager", (String)("restoreAllState: adding bse #" + n + " (index " + object.mIndex + "): " + object));
            }
    ...
    Parcelable saveAllState() {
        block14 : {
            block13 : {
                ...
                int n2 = 0;
                for (int i = 0; i < n; ++i) {
                    Object object = (Fragment)this.mActive.get(i);
                    if (object == null) continue;
                    if (object.mIndex < 0) {
                        object = "Failure saving state: active " + object + " has cleared index: " + object.mIndex;
                        Log.e((String)"FragmentManager", (String)object);
                        this.dump("  ", null, new PrintWriter((Writer)new LogWriter("FragmentManager")), new String[0]);
                        throw new IllegalStateException((String)object);
                    }
                    int n3 = 1;
                    int[] arrn = new int[]((Fragment)object);
                    arrfragmentState[i] = arrn;
                    if (object.mState > 0 && arrn.mSavedFragmentState == null) {
                        arrn.mSavedFragmentState = this.saveFragmentBasicState((Fragment)object);
                        if (object.mTarget != null) {
                            if (object.mTarget.mIndex < 0) {
                                object = "Failure saving state: " + object + " has target not in fragment manager: " + object.mTarget;
                                Log.e((String)"FragmentManager", (String)object);
                                this.dump("  ", null, new PrintWriter((Writer)new LogWriter("FragmentManager")), new String[0]);
                                throw new IllegalStateException((String)object);
                            }
                            if (arrn.mSavedFragmentState == null) {
                                arrn.mSavedFragmentState = new Bundle();
                            }
                            this.putFragment(arrn.mSavedFragmentState, "android:target_state", object.mTarget);
                            if (object.mTargetRequestCode != 0) {
                                arrn.mSavedFragmentState.putInt("android:target_req_state", object.mTargetRequestCode);
                            }
                        }
                    } else {
                        arrn.mSavedFragmentState = object.mSavedFragmentState;
                    }
                    n2 = n3;
                    if (!DEBUG) continue;
                    Log.v((String)"FragmentManager", (String)("Saved state of " + object + ": " + (Object)arrn.mSavedFragmentState));
                    n2 = n3;
                }
