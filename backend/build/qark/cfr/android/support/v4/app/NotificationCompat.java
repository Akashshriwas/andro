...
public class NotificationCompat {
    ...
    private static final NotificationCompatImpl IMPL = Build.VERSION.SDK_INT >= 16 ? new NotificationCompatImplJellybean() : (Build.VERSION.SDK_INT >= 13 ? new NotificationCompatImplIceCreamSandwich() : (Build.VERSION.SDK_INT >= 11 ? new NotificationCompatImplHoneycomb() : new NotificationCompatImplBase()));
    ...
    implements NotificationCompatImpl {
        ...
        public Notification build(Builder object) {
            ...
            notificationCompatJellybean.addBigPictureStyle(object.mBigContentTitle, object.mSummaryTextSet, object.mSummaryText, object.mPicture);
            return notificationCompatJellybean.build();
        }
    }
