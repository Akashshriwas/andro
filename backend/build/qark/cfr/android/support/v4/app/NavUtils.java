...
public class NavUtils {
    ...
    public static Intent getParentActivityIntent(Context object, ComponentName componentName) throws PackageManager.NameNotFoundException {
        if ((object = NavUtils.getParentActivityName((Context)object, componentName)) == null) {
            return null;
        }
        return new Intent().setClassName(componentName.getPackageName(), (String)object);
    }
    ...
    public static Intent getParentActivityIntent(Context context, Class<?> object) throws PackageManager.NameNotFoundException {
        ...
        return new Intent().setClassName(context, (String)object);
    }
    ...
    implements NavUtilsImpl {
        ...
        public Intent getParentActivityIntent(Activity activity) {
            ...
            return new Intent().setClassName((Context)activity, string2);
        }
    ...
    extends NavUtilsImplBase {
        ...
        public Intent getParentActivityIntent(Activity activity) {
            ...
            if (intent == null) {
                intent2 = super.getParentActivityIntent(activity);
            }
            return intent2;
        }
