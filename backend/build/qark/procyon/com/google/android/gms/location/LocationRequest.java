...
public final class LocationRequest implements SafeParcelable
{
    ...
    LocationRequest(final int i, final int a, final long b, final long c, final boolean d, final long e, final int f, final float g) {
        this.i = i;
        this.a = a;
        this.b = b;
        this.c = c;
    ...
    public String toString() {
        ...
        if (this.e != Long.MAX_VALUE) {
            ...
            sb.append(" expireIn=");
            sb.append(e - elapsedRealtime + "ms");
        }
