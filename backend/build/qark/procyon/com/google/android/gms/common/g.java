...
public final class g
{
    ...
    public static int a(final Context context) {
        ...
        while (true) {
            try {
                context.getResources().getString(com.google.android.gms.b.common_google_play_services_unknown_issue);
        ...
        byte[] a;
        try {
            a = a(packageManager.getPackageInfo("com.android.vending", 64), com.google.android.gms.common.g.a);
            if (a == null) {
        ...
        if (packageInfo.versionCode < 4132500) {
            Log.w("GooglePlayServicesUtil", "Google Play services out of date.  Requires 4132500 but found " + packageInfo.versionCode);
            return 2;
        }
        try {
    ...
    public static Intent a(final Context context, final int n, final int n2) {
        switch (n) {
            ...
            case 2: {
                if (!a(n2)) {
                    return gn.b("com.google.android.gms");
                }
                if (e(context)) {
                    return gn.c("com.google.android.gms");
                }
                return gn.b("com.google.android.apps.bazaar");
            }
            case 3: {
                return gn.a("com.google.android.gms");
            }
            case 12: {
                return gn.a();
            }
    ...
    public static boolean a() {
        if (com.google.android.gms.common.g.f) {
            return com.google.android.gms.common.g.g;
        }
    ...
    private static byte[] a(final PackageInfo p0, final byte[]... p1) {
        ...
        //    17: ldc             "Package has more than one signature."
        //    19: invokestatic    android/util/Log.w:(Ljava/lang/String;Ljava/lang/String;)I
        //    22: pop            
        //    23: aconst_null    
        //    24: areturn        
        //    25: astore_0       
        //    26: ldc             "GooglePlayServicesUtil"
        //    28: ldc             "Could not get certificate instance."
        //    30: invokestatic    android/util/Log.w:(Ljava/lang/String;Ljava/lang/String;)I
        //    33: pop            
        //    34: aconst_null    
        //    35: areturn        
        ...
        //    39: dup            
        //    40: aload_0        
        //    41: getfield        android/content/pm/PackageInfo.signatures:[Landroid/content/pm/Signature;
        //    44: iconst_0       
        //    45: aaload         
        //    46: invokevirtual   android/content/pm/Signature.toByteArray:()[B
        //    49: invokespecial   java/io/ByteArrayInputStream.<init>:([B)V
        //    52: astore          4
        //    54: aload_3        
        //    55: aload           4
        //    57: invokevirtual   java/security/cert/CertificateFactory.generateCertificate:(Ljava/io/InputStream;)Ljava/security/cert/Certificate;
        //    60: checkcast       Ljava/security/cert/X509Certificate;
        //    63: astore_3       
        //    64: aload_3        
        //    65: invokevirtual   java/security/cert/X509Certificate.checkValidity:()V
        //    68: aload_0        
        //    69: getfield        android/content/pm/PackageInfo.signatures:[Landroid/content/pm/Signature;
        //    72: iconst_0       
        //    73: aaload         
        //    74: invokevirtual   android/content/pm/Signature.toByteArray:()[B
        //    77: astore_0       
        //    78: iconst_0       
        //    79: istore_2       
        //    80: iload_2        
        ...
        //    90: aload_3        
        //    91: aload_0        
        //    92: invokestatic    java/util/Arrays.equals:([B[B)Z
        //    95: ifeq            136
        //    98: aload_3        
        //    99: areturn        
        //   100: astore_0       
        //   101: ldc             "GooglePlayServicesUtil"
        //   103: ldc_w           "Could not generate certificate."
        //   106: invokestatic    android/util/Log.w:(Ljava/lang/String;Ljava/lang/String;)I
        //   109: pop            
        //   110: aconst_null    
        //   111: areturn        
        //   112: astore_0       
        //   113: ldc             "GooglePlayServicesUtil"
        //   115: ldc_w           "Certificate has expired."
        //   118: invokestatic    android/util/Log.w:(Ljava/lang/String;Ljava/lang/String;)I
        //   121: pop            
        //   122: aconst_null    
        //   123: areturn        
        //   124: astore_0       
        //   125: ldc             "GooglePlayServicesUtil"
        //   127: ldc_w           "Certificate is not yet valid."
        //   130: invokestatic    android/util/Log.w:(Ljava/lang/String;Ljava/lang/String;)I
        //   133: pop            
        //   134: aconst_null    
        //   135: areturn        
        //   136: iload_2        
        ...
        //   145: iconst_2       
        //   146: invokestatic    android/util/Log.isLoggable:(Ljava/lang/String;I)Z
        //   149: ifeq            182
        //   152: ldc             "GooglePlayServicesUtil"
        //   154: new             Ljava/lang/StringBuilder;
        //   157: dup            
        //   158: invokespecial   java/lang/StringBuilder.<init>:()V
        //   161: ldc_w           "Signature not valid.  Found: \n"
        //   164: invokevirtual   java/lang/StringBuilder.append:(Ljava/lang/String;)Ljava/lang/StringBuilder;
        //   167: aload_0        
        //   168: iconst_0       
        //   169: invokestatic    android/util/Base64.encodeToString:([BI)Ljava/lang/String;
        ...
        //   178: invokestatic    android/util/Log.v:(Ljava/lang/String;Ljava/lang/String;)I
        //   181: pop            
        //   182: aconst_null    
        //   183: areturn        
        //    Exceptions:
        ...
        //  -----  -----  -----  -----  ----------------------------------------------------
        //  0      6      25     36     Ljava/security/cert/CertificateException;
        //  54     64     100    112    Ljava/security/cert/CertificateException;
        //  64     68     112    124    Ljava/security/cert/CertificateExpiredException;
        //  64     68     124    136    Ljava/security/cert/CertificateNotYetValidException;
        // 
    ...
    public static void b(final Context context) {
        ...
        final Intent a2 = a(context, a, -1);
        Log.e("GooglePlayServicesUtil", "GooglePlayServices not available due to error " + a);
        if (a2 == null) {
            throw new e(a);
        }
        throw new f(a, "Google Play Services not available", a2);
    }
    ...
    private static void d(final Context context) {
        ...
        throw new IllegalStateException("The meta-data tag in your app's AndroidManifest.xml does not have the right value.  Expected 4132500 but found " + int1 + ".  You must have the" + " following declaration within the <application> element: " + "    <meta-data android:name=\"" + "com.google.android.gms.version" + "\" android:value=\"@integer/google_play_services_version\" />");
    }
    
    private static boolean e(final Context context) {
        boolean h = false;
        if (com.google.android.gms.common.g.f) {
            h = com.google.android.gms.common.g.h;
        }
        else {
            try {
                if (a(context.getPackageManager().getPackageInfo("com.google.android.apps.bazaar", 64), com.google.android.gms.common.g.e) != null) {
                    return true;
                }
            }
            catch (PackageManager$NameNotFoundException ex) {
