...
public final class ea
{
    ...
    public ea(final Context context) {
        ...
        this.b = (a(packageManager, "geo:0,0?q=donuts") != null);
        this.c = (a(packageManager, "http://www.google.com") != null && b);
    ...
    private static int a(final Context context, final ConnectivityManager connectivityManager, final PackageManager packageManager) {
        int type = -2;
        if (em.a(packageManager, context.getPackageName(), "android.permission.ACCESS_NETWORK_STATE")) {
