...
public final class je
{
    ...
    private je(final byte[] a, final int c, final int n) {
        this.a = a;
        this.c = c;
        this.b = c + n;
    }
    
    public static je a(final byte[] array) {
        return a(array, 0, array.length);
    }
    
    public static je a(final byte[] array, final int n, final int n2) {
        return new je(array, n, n2);
    }
