...
public class FragmentActivity extends Activity
{
    ...
    LoaderManagerImpl getLoaderManager(final int n, final boolean b, final boolean b2) {
        if (this.mAllLoaderManagers == null) {
            this.mAllLoaderManagers = new SparseArrayCompat<LoaderManagerImpl>();
        }
        LoaderManagerImpl loaderManagerImpl = this.mAllLoaderManagers.get(n);
        if (loaderManagerImpl == null) {
            if (b2) {
                loaderManagerImpl = new LoaderManagerImpl(this, b);
    ...
    public LoaderManager getSupportLoaderManager() {
        ...
        return this.mLoaderManager = this.getLoaderManager(-1, this.mLoadersStarted, true);
    }
    
    void invalidateSupportFragmentIndex(final int n) {
        if (this.mAllLoaderManagers != null) {
            final LoaderManagerImpl loaderManagerImpl = this.mAllLoaderManagers.get(n);
    ...
    public View onCreateView(String attributeValue, final Context context, final AttributeSet set) {
        ...
        if ((obj = fragmentByTag) == null) {
            obj = fragmentByTag;
            if (-1 != 0) {
                obj = this.mFragments.findFragmentById(0);
            }
        }
        if (FragmentManagerImpl.DEBUG) {
            Log.v("FragmentActivity", "onCreateView: id=0x" + Integer.toHexString(resourceId) + " fname=" + string + " existing=" + obj);
        }
        if (obj == null) {
            obj = Fragment.instantiate((Context)this, string);
    ...
    public boolean onPreparePanel(final int n, final View view, final Menu menu) {
        ...
        if (n == 0 && menu != null) {
            ...
            boolean b2 = b;
            if (super.onPreparePanel(n, view, menu) | this.mFragments.dispatchPrepareOptionsMenu(menu)) {
                b2 = b;
    ...
    public final Object onRetainNonConfigurationInstance() {
        ...
        int n2 = 0;
        if (this.mAllLoaderManagers != null) {
            int n3 = this.mAllLoaderManagers.size() - 1;
            while (true) {
                n = n2;
                if (n3 < 0) {
                    break;
                }
                final LoaderManagerImpl loaderManagerImpl = this.mAllLoaderManagers.valueAt(n3);
                if (loaderManagerImpl.mRetaining) {
                    n2 = 1;
                }
                else {
                    loaderManagerImpl.doDestroy();
                    this.mAllLoaderManagers.removeAt(n3);
                }
                --n3;
            }
        }
    ...
    protected void onStart() {
        ...
        if (this.mAllLoaderManagers != null) {
            for (int i = this.mAllLoaderManagers.size() - 1; i >= 0; --i) {
                final LoaderManagerImpl loaderManagerImpl = this.mAllLoaderManagers.valueAt(i);
