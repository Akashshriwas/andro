...
final class FragmentManagerImpl extends FragmentManager
{
    ...
    public Fragment getFragment(final Bundle bundle, final String s) {
        ...
        if (int1 == -1) {
            ...
            if ((fragment = this.mActive.get(int1)) == null) {
                throw new IllegalStateException("Fragement no longer exists for key " + s + ": index " + int1);
            }
        }
        return fragment;
    ...
    void makeActive(final Fragment obj) {
        if (obj.mIndex < 0) {
            if (this.mAvailIndices == null || this.mAvailIndices.size() <= 0) {
                ...
                obj.setIndex(this.mActive.size());
                this.mActive.add(obj);
            }
            else {
                obj.setIndex(this.mAvailIndices.remove(this.mAvailIndices.size() - 1));
    ...
    void makeInactive(final Fragment obj) {
        ...
        this.mActivity.invalidateSupportFragmentIndex(obj.mIndex);
        obj.initState();
    }
                    ...
                    case 1: {
                        ...
                        if (!fragment.mFromLayout) {
                            ...
                            if (fragment.mContainerId != 0) {
                                final ViewGroup viewGroup = (ViewGroup)this.mActivity.findViewById(fragment.mContainerId);
        ...
        if (parcelable != null) {
            ...
            if (fragmentManagerState.mActive != null) {
                ...
                for (int m = 0; m < fragmentManagerState.mBackStack.length; ++m) {
                    ...
                    if (FragmentManagerImpl.DEBUG) {
                        Log.v("FragmentManager", "restoreAllState: adding bse #" + m + " (index " + instantiate2.mIndex + "): " + instantiate2);
                    }
    ...
    Parcelable saveAllState() {
        ...
        if (this.mActive != null && this.mActive.size() > 0) {
            ...
            for (int i = 0; i < size; ++i) {
                ...
                if (obj != null) {
                    if (obj.mIndex < 0) {
                        final String string = "Failure saving state: active " + obj + " has cleared index: " + obj.mIndex;
                    ...
                    if (obj.mState > 0 && fragmentState.mSavedFragmentState == null) {
                        ...
                        if (obj.mTarget != null) {
                            if (obj.mTarget.mIndex < 0) {
                                final String string2 = "Failure saving state: " + obj + " has target not in fragment manager: " + obj.mTarget;
                ...
                if (this.mAdded != null) {
                    ...
                    if (size2 > 0) {
                        ...
                        while (true) {
                            ...
                            if (array3[n] < 0) {
                                final String string3 = "Failure saving state: active " + this.mAdded.get(n) + " has cleared index: " + array3[n];
