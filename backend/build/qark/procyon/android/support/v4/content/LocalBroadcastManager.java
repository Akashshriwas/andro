                    ...
                    while (true) {
                        Label_0521: {
                            while (true) {
                                ...
                                Label_0510: {
                                    Label_0502: {
                                        ...
                                        synchronized (this.mReceivers) {
                                            ...
                                            Label_0323_Outer:Block_13_Outer:Block_15_Outer:
                                            while (true) {
                                                Block_16:Block_11_Outer:Label_0214_Outer:
                                                while (true) {
                                                    while (true) {
                                                    Block_12:
                                                        while (true) {
                                                            ...
                                                            Block_14:
                                                                while (true) {
                                                                    Block_17: {
                                                                        break Block_17;
                                                                        ((ArrayList<ReceiverRecord>)o).add(e);
                                                                        e.broadcasting = true;
                                                                        break Label_0510;
                                                                        o = list;
                                                                        break Block_14;
                                ...
                                ++index;
                                list = (ArrayList<ReceiverRecord>)o;
                                continue Block_4_Outer;
                            }
                        }
                        int n = 0;
                    ...
                    while (true) {
                        Label_0173: {
                            Label_0168: {
                                ...
                                // iftrue(Label_0173:, (ReceiverRecord)list2.get(n).receiver != broadcastReceiver)
