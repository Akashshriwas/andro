  ...
  public void draw(Canvas paramCanvas)
  {
    ...
    if ((m == 0) || ((m == 1) && (mAdapter != null) && (mAdapter.getCount() > 1)))
    {
      ...
      if (!mRightEdge.isFinished())
      {
        ...
        paramCanvas.translate(-getPaddingTop(), -(mLastOffset + 1.0F) * i);
        mRightEdge.setSize(n - i1 - i2, i);
      ...
      if (((View)localObject2).getVisibility() != 8)
      {
        ...
        if (!isDecor)
        {
          ...
          if (localObject1 != null)
          {
            ...
            {
              needsMeasure = false;
              ((View)localObject2).measure(View.MeasureSpec.makeMeasureSpec((int)((j - paramInt2 - m) * widthFactor), 1073741824), View.MeasureSpec.makeMeasureSpec(k - paramInt1 - paramInt4, 1073741824));
            }
      ...
      if (localView.getVisibility() != 8)
      {
        ...
        if (localLayoutParams != null)
        {
          ...
          if (isDecor)
          {
            ...
            localView.measure(View.MeasureSpec.makeMeasureSpec(m, i4), View.MeasureSpec.makeMeasureSpec(i3, k));
            if (n == 0) {
              break label391;
            }
  ...
  public boolean onTouchEvent(MotionEvent paramMotionEvent)
  {
    ...
    for (;;)
    {
      ...
      if (mIsBeingDragged)
      {
        Object localObject = mVelocityTracker;
        ((VelocityTracker)localObject).computeCurrentVelocity(1000, mMaximumVelocity);
        int m = (int)VelocityTrackerCompat.getXVelocity((VelocityTracker)localObject, mActivePointerId);
        mPopulatePending = true;
        i = getWidth();
        j = getScrollX();
        localObject = infoForCurrentScrollPosition();
        setCurrentItemInternal(determineTargetPage(position, (j / i - offset) / widthFactor, m, (int)(MotionEventCompat.getX(paramMotionEvent, MotionEventCompat.findPointerIndex(paramMotionEvent, mActivePointerId)) - mInitialMotionX)), true, true, m);
        mActivePointerId = -1;
        endDrag();
